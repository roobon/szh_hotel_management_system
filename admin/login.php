...
<body>
  ...
  <div class="container">
    ...
    <form class="form-signin" method="POST" action="login.php">
      ...
      <input type="text" class="form-control" placeholder="Email address" name="email" value="joken@yahoo.com" autofocus>
      <input type="password" class="form-control" placeholder="Password" value="1234" name="pass">
