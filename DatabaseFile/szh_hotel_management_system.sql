...
--
-- Host: localhost
-- Generation Time: Dec 04, 2022 at 10:40 PM
...
--
-- Database: `szh_hotel_management_system`
--
...
--
ALTER TABLE `amenities`
  MODIFY `amen_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `guest`
  MODIFY `guest_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `room`
  MODIFY `roomNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
